...
var presenter = {
	...
	ShowNext : function () {
		...
		if($('#slide_container').css('left')=='0px')
			{
				$('#slide_container').stop().animate({'left':'-1024px'},200);
				
			}
		else if($('#slide_container').css('left')=='1024px')
			{
				$('#slide_container').stop().animate({'left':'0'},200);
			}
	...
	ShowLast : function () {
		...
		if($('#slide_container').css('left')=='-1024px')
			{
				$('#slide_container').stop().animate({'left':'0px'},200);
	...
	$(document).keydown(function(e){
		...
		switch(e.keyCode ){
		//new By ME
		case 39:presenter.ShowNext();e.preventDefault();break;//right arrow
		case 37:presenter.ShowLast();e.preventDefault();break;//left arrow
		
		case 13:presenter.Next();e.preventDefault();break;//enter
		case 34:presenter.Next();e.preventDefault();break;//page down
		case 32:presenter.Next();e.preventDefault();break;//space
		case 40:presenter.Next();e.preventDefault();break;//down arrow
		
		case 8:presenter.Prev();e.preventDefault();break;//backspace
		case 33:presenter.Prev();e.preventDefault();break;//page up
		case 38:presenter.Prev();e.preventDefault();break;//up arrow
		default:return;
		}
